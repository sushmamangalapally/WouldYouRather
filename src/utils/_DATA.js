...
function formatQuestion (objectQuestions) {
  var optionOneTextText = objectQuestions.optionOneText
  var optionTwoTextText = objectQuestions.optionTwoText
  var author = objectQuestions.author;
